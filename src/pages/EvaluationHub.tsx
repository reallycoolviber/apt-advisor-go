                        ...
                        {data.general?.finalPrice && (
                         ...
                         {data.general?.price && data.general?.size && (
                           <div className="flex justify-between py-2">
                             <span className="text-sm text-muted-foreground">Pris per kvm:</span>
                             <span className="text-sm font-medium text-foreground">{formatDisplayValue(Math.round(parseInt(data.general.price.replace(/\s/g, '')) / parseInt(data.general.size)), 'price_per_sqm')}</span>
                           </div>
                         )}
                      </div>
                    ) : (

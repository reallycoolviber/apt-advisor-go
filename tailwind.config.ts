...
export default {
	...
	theme: {
		...
		extend: {
			...
			fontSize: {
				'display': 'var(--font-size-xxl)',
				'title': 'var(--font-size-xl)', 
				'heading': 'var(--font-size-lg)',
				'prominent': 'var(--font-size-md)',
				'body': 'var(--font-size-base)',
				'small': 'var(--font-size-sm)',
				// Keep standard Tailwind sizes for backward compatibility
				'xs': '0.75rem',
				'sm': '0.875rem', 
				'base': '1rem',
				'lg': '1.125rem',
			...
			lineHeight: {
				'display': 'var(--line-height-xxl)',
				'title': 'var(--line-height-xl)',
				'heading': 'var(--line-height-lg)', 
				'prominent': 'var(--line-height-md)',
				'body': 'var(--line-height-base)',
				'small': 'var(--line-height-sm)'
			},
			borderRadius: {
				lg: 'var(--radius)',
